...
contextBridge.exposeInMainWorld('api', {
  ...
  waIzinliler: () => cagir('waIzinliler'),
  waIzinlileriYaz: (metin) => cagir('waIzinlileriYaz', metin),
  havaDenemesi: () => cagir('havaDenemesi'),
  ...
  binaCalistir: (numara) => cagir('binaCalistir', numara),
  ...
  mailAyar: () => cagir('mailAyar'),
  mailAyarYaz: (gelen) => cagir('mailAyarYaz', gelen),
  mailYedekSec: () => cagir('mailYedekSec'),
  mailYedekAc: () => cagir('mailYedekAc'),
  mailKlasorler: () => cagir('mailKlasorler'),
  mailOzet: (istek) => cagir('mailOzet', istek),
  mailSil: (istek) => cagir('mailSil', istek),
  mailDinle: (fn) => { ipcRenderer.on('mailIlerleme', (_o, veri) => fn(veri)); },
